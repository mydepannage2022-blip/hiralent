        ...
        <div className='w-full lg:w-1/2 flex flex-col justify-start items-center lg:items-center lg:gap-5 p-3'>
          <div className='flex justify-center items-center gap-3 p-8 lg:p-4 xl:p-8'>
            ...
            <Link href='/signup/location' className='py-1 px-6 md:px-10 lg:px-12 bg-[#063B82] rounded-lg'>
             ...
             <Link href='/signup/salary' className='py-1 px-6 md:px-10 lg:px-12 bg-[#CFE3FF] rounded-lg'>
            </Link>      
             <Link href='/signup/uploadresume' className='py-1 px-6 md:px-10 lg:px-12 bg-[#CFE3FF] rounded-lg'>
            </Link>
          </div>
          ...
          <div className='flex flex-col justify-center items-center gap-3 text-[#222]'>
            ...
            <p className='text-center text-xs lg:text-sm w-full lg:w-2/3'>Please We use this to match you nearby offers.</p>
          </div>
