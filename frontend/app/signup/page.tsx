...
const Page = () => {
  ...
  const getInputClassName = (fieldName: keyof FormData) => {
    const baseClass = 'w-full px-4 py-3 border rounded-lg focus:outline-none text-sm text-[#757575]'
      ...
      <div className='w-full flex flex-col lg:flex-row justify-between items-start lg:gap-0 xl:gap-16'>
        <div className='w-full lg:w-1/2 flex flex-col justify-start items-center lg:items-center lg:gap-0 xl:gap-4 p-3'>
          <div className='flex justify-center items-center gap-3 p-8 lg:p-4 xl:p-8'>
            ...
            <Link href='/signup/location' className='py-1 px-6 md:px-10 lg:px-12 bg-[#CFE3FF] rounded-lg'>
            </Link>
             <Link href='/signup/location' className='py-1 px-6 md:px-10 lg:px-12 bg-[#CFE3FF] rounded-lg'>
            </Link>       
             <Link href='/signup/location' className='py-1 px-6 md:px-10 lg:px-12 bg-[#CFE3FF] rounded-lg'>
          ...
          <div className='flex justify-center items-center'>
            <Link className='border-r-1 border-t-1 border-b-1 rounded-t-none rounded-l-lg border-[#005DDC] bg-[#005DDC] py-2 px-8 text-sm' href={"/signup/info"}>As a Candidate</Link>
            <Link className='border-r-1 border-t-1 border-b-1 rounded-t-none rounded-r-lg border-[#005DDC] bg-white py-2 px-8 text-sm text-[#222]' href={"/companyRegister"}>As a Company</Link>
          </div>
