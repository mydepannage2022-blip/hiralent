...
const DashboardProfilePercentage = () => {
  ...
  return (
    <div className='w-full relative'>
      <div 
        className='w-full flex justify-start items-start bg-white lg:p-4 xl:p-8 rounded-xl lg:gap-2 xl:gap-8 text-[#222] cursor-pointer transition-all duration-200 hover:shadow-lg'
      ...
      >
        ...
        <div className='flex flex-col justify-start items-start gap-1'>
          <h2 className='font-bold lg:text-sm xl:text-xl'>
            <span className='text-[#005DDC]'>{completionPercentage}%</span> of Your Profile is Complete
          </h2>
        ...
        <div className='flex justify-center items-center gap-4'>
          <div className='flex flex-col items-start justify-start gap-2 ring ring-[#EDEDED] p-2 rounded-lg'>
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="26" viewBox="0 0 27 26" fill="none">
              <path d="M23.3369 11.0174C21.9384 8.67523 18.7994 4.74609 13.5005 4.74609C8.20153 4.74609 5.06253 8.67523 3.66403 11.0174C2.9323 12.2402 2.9323 13.7602 3.66403 14.984C5.06253 17.3262 8.20153 21.2554 13.5005 21.2554C18.7994 21.2554 21.9384 17.3262 23.3369 14.984C24.0686 13.7602 24.0686 12.2412 23.3369 11.0174ZM21.966 14.1639C20.7411 16.2153 18.0112 19.6577 13.5005 19.6577C8.98972 19.6577 6.25983 16.2163 5.03495 14.1639C4.60678 13.446 4.60678 12.5544 5.03495 11.8365C6.25983 9.78513 8.98972 6.34272 13.5005 6.34272C18.0112 6.34272 20.7411 9.78406 21.966 11.8365C22.3952 12.5555 22.3952 13.446 21.966 14.1639ZM13.5005 8.47399C11.0038 8.47399 8.97374 10.5052 8.97374 13.0007C8.97374 15.4963 11.0038 17.5275 13.5005 17.5275C15.9971 17.5275 18.0272 15.4963 18.0272 13.0007C18.0272 10.5052 15.9971 8.47399 13.5005 8.47399ZM13.5005 15.9298C11.8847 15.9298 10.5714 14.6165 10.5714 13.0007C10.5714 11.3849 11.8847 10.0717 13.5005 10.0717C15.1163 10.0717 16.4295 11.3849 16.4295 13.0007C16.4295 14.6165 15.1163 15.9298 13.5005 15.9298Z" fill="#009E00"/>
            </svg>
          ...
          {missingFields.length > 0 && (
            <div className='mb-3'>
              ...
              <div className='space-y-1'>
                {missingFields.slice(0, 4).map((field: string, index: number) => (
