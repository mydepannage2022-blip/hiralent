    ...
    <div className='w-full flex justify-center items-center'>
      ...
      <div className='w-5/6 lg:max-w-4xl xl:max-w-7xl lg:w-4xl xl:w-7xl flex justify-center items-center flex flex-col lg:flex-row bg-tranparent pb-12 lg:pt-[150px] gap-16'>
        ...
        <div className='w-full lg:w-1/2 flex flex-col items-center lg:items-start justify-center w-full w-1/2 gap-8 bg-none dark:bg-tranparent dark:backdrop-blur-sm py-0 pt-8 lg:py-8 pr-0 lg:pr-8 rounded-3xl'>
          <h1 className='text-2xl lg:text-5xl font-bold text-[#1B1B1B] dark:text-white text-center lg:text-left'>Why Choose <span className='text-[#1B1B1B] dark:text-[#00F5DA]'>Talenta</span></h1>
          <h4 className='text-base lg:text-lg font-medium text-[#2C2F38]/90 dark:text-white text-center lg:text-left'>Access The <span className='text-[#1B1B1B] dark:text-[#00F5DA]'>Fastest</span><br></br>
          <span className='text-[#1B1B1B] dark:text-[#00F5DA]'>Growing, Diverse </span>Telant Pool 
          </h4>
