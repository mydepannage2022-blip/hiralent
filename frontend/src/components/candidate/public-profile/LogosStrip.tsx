    ...
    return (
        <section className="px-4 sm:max-w-[690px] md:max-w-[920px] lg:max-w-5xl xl:max-w-7xl container mx-auto border-b border-gray-200">
            <div className="py-6 flex flex-wrap items-center justify-between">
                ...
                {/* Logos */}
                <div className="grid grid-cols-2 sm:grid-cols-4 items-center gap-6 sm:gap-10">
                    <Image
