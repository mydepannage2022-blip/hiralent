  ...
  const testimonials = [
    {
      ...
      rating: 5,
      image: "https://www.dia-m.ru/upload/medialibrary/105/fo17oinkvc8cqpm4tnjacb649hdoju80/Chief-Executive-Officer_-Mike-Roman.jpg",
    },
    {
      name: "Huzaifa Iqbal",
      ...
      <div className="w-full max-w-7xl px-4 flex flex-col lg:flex-row justify-between items-center gap-10">
        ...
        <div className="flex flex-col items-center lg:items-start gap-6 w-full lg:w-1/2 text-center lg:text-left">
          <h1 className="text-2xl lg:text-5xl text-white font-bold">
            What our <span className="text-[#00F5DA]">Client says</span>
          </h1>
          <p className="text-sm lg:text-base font-light">
            Hear directly from our happy clients — their words reflect our commitment to quality, trust, and excellence.
          </p>
          ...
          <div className="flex gap-4 mt-4">
            <button
              ref={prevRef}
              className="bg-gradient-to-r from-[#00F5DA] to-[#28196A] text-white px-4 py-2 rounded hover:bg-[#00dbc0] transition"
            >
              <ChevronLeft />
            </button>
            <button
              ref={nextRef}
              className="bg-gradient-to-r from-[#28196A] to-[#00F5DA] text-white px-4 py-2 rounded hover:bg-[#00dbc0] transition"
            >
              <ChevronRight />
            </button>
          </div>
            ...
            >
              {testimonials.map((testimonial, index) => (
                <SwiperSlide key={index}>
                  <div className="bg-white shadow-md rounded-xl p-6 text-center hover:shadow-lg transition-shadow duration-300 w-4/5 mx-auto ring-1 ring-white/10 shadow-lg backdrop-blur-sm cursor-move">
                    <img
                    ...
                    {/* Star Rating */}
                    <div className="flex justify-center mt-2 mb-1 text-yellow-500">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} size={18} fill={i < testimonial.rating ? "#facc15" : "none"} />
                      ))}
                    </div>
