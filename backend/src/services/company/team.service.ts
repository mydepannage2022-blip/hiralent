...
export async function inviteTeamMember(
  ...
  return {
    ...
    invited_by: {
      ...
      full_name: invitation.inviter?.full_name ?? 'Deleted user',
    },
...
return {
    ...
    invited_by: {
      ...
      full_name: updated.inviter?.full_name ?? 'Deleted user',
    },
...
export async function getTeamList(
  ...
  const formattedInvitations: TeamInvitationResponse[] = invitations.map(inv => ({
    ...
    invited_by: {
      ...
      full_name: inv.inviter?.full_name ?? 'Deleted user',
    },
  ...
  return {
    logs: logs.map(log => ({
      ...
      actor: {
        ...
        full_name: log.actor?.full_name ?? 'Deleted user',
